...
public class ElytraFlight
    ...
    public void onMove(MoveEvent event) {
        if (this.mode.getValue() == Mode.OHARE) {
            ...
            ElytraFlight.mc.player.motionX -= ElytraFlight.mc.player.movementInput.moveForward * Math.sin(yaw) * 0.04;
            ElytraFlight.mc.player.motionZ += ElytraFlight.mc.player.movementInput.moveForward * Math.cos(yaw) * 0.04;
        }
    }
