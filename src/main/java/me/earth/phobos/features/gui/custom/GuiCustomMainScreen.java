...
public class GuiCustomMainScreen
    ...
    public void initGui() {
        ...
        this.buttonList.add(new TextButton(2, this.x, this.y + 88, "Cope"));
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        ...
        } else if (GuiCustomMainScreen.isHovered(this.x - Phobos.textManager.getStringWidth("Cope") / 2, this.y + 88, Phobos.textManager.getStringWidth("Cope"), Phobos.textManager.getFontHeight(), mouseX, mouseY)) {
            this.mc.shutdown();
        }
    }
    ...
    private static class TextButton
        ...
        public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks) {
            if (this.visible) {
                ...
                if (this.hovered) {
                    RenderUtil.drawLine((float) (this.x - 1) - (float) Phobos.textManager.getStringWidth(this.displayString) / 2.0f, this.y + 2 + Phobos.textManager.getFontHeight(), this.x + (float) Phobos.textManager.getStringWidth(this.displayString) / 2.0f + 1.0f, this.y + 2 + Phobos.textManager.getFontHeight(), 1.0f, Color.WHITE.getRGB());
                }
            }
        }
